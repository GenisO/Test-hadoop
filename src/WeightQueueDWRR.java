...
public class WeightQueueDWRR<E extends RequestObjectDWRR> implements Queue<E> {
  ...
  public void setEndOrder(RequestObjectDWRR req) {
    order.add(req.getRequestId());
  }

  @Override
  public boolean equals(Object o) {
    if (this == o) return true;
    if (!(o instanceof org.apache.hadoop.hdfs.protocol.datatransfer.WeightQueueDWRR)) return false;

    org.apache.hadoop.hdfs.protocol.datatransfer.WeightQueueDWRR that = (org.apache.hadoop.hdfs.protocol.datatransfer.WeightQueueDWRR) o;
